...
const mg = mailgun({ apiKey: process.env.MAILGUN_API, domain: DOMAIN, url : "https://api.eu.mailgun.net" });
...
const verifyEmail = async (email) => {
    ...
    const data = {
        ...
        'h:X-Mailgun-Variables': JSON.stringify({ "verificationCode": verificationCode })
    };
